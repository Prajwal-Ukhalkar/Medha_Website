        ...
        <div class="grid grid-cols-1">
            <div class="gap-2 mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                <div data-aos="fade-right" data-aos-duration=1000
                    ...
                    <img class="w-[150px] h-auto mt-2 md:h-auto object-cover rounded-full bg-yellow-200"
                        src="members/Founder/founders/Hon._Balasaheb_Thorat.png" alt="" />
                ...
                <div
                    ...
                    <img class="w-[150px] h-auto mt-2 md:h-auto object-cover rounded-full bg-yellow-200"
                        src="members/Founder/founders/Hon.Dr._Sudhir_Tambe.png" alt="" />
                    <div data-aos="fade-right" data-aos-duration=1000
                        class="p-6 flex flex-col text-gray-900 text-center gap-5 justify-center max-w-[400px]">
                ...
                <div data-aos="fade-left" data-aos-duration=1000
                    ...
                    <img class="w-[150px] h-auto mt-2 md:h-auto object-cover rounded-full bg-yellow-200"
                        src="members/Founder/founders/Hon._Sharayu_Deshmukh.png" alt="" />
                    <div data-aos="fade-right" data-aos-duration=1000
                        class="p-6 flex flex-col text-gray-900 text-center gap-5 justify-center max-w-[400px]">
                ...
                <div data-aos="fade-left" data-aos-duration=1000
                    ...
                    <img class="w-[150px] h-auto mt-2 md:h-auto object-cover rounded-full bg-yellow-200"
                        src="members/Founder/founders/Hon._Rajvardhan_Thorat.png" alt="" />
                    <div class="p-6 flex flex-col text-gray-900 text-center gap-5 justify-center max-w-[400px]">
                ...
                <div data-aos="fade-right" data-aos-duration=1000
                    ...
                    <img class="w-[150px] h-auto mt-2 md:h-auto object-cover rounded-full bg-yellow-200"
                        src="members/Founder/founders/Hon._Anil_Shinde.png" alt="" />
                    <div class="p-6 flex flex-col text-gray-900 text-center gap-5 justify-center max-w-[400px]">
            ...
            <div class="embed-responsive embed-responsive-16by9 relative w-full overflow-hidden"
                ...
                <iframe data-aos="zoom-in" data-aos-duration=1000
                    ...
                    src="../res/aboutVid/v.mp4" allowfullscreen="" autoplay="none"
